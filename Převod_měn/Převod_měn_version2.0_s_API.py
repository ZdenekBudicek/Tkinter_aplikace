...
def count():
    if len(user_input.get()) < 13:
        try:
            ...
            payload = {}
            headers = {
                "apikey": "66wY8LVtoXkXKA2c9L7Lt2MDkr44FlaW"
            }
        ...
        notification_label.config(text="")
        notification_label.config(text="Maximum je 12 místné číslo.")


# Uživatelský vstup                     justify = zarovná text v inputu
